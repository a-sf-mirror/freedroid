...
struct widget_autoscroll_text {
	...
	float scrolling_speed;     /**< 'absolute' scrolling speed **/
	int scrolling_speed_mult;  /**< Multiplier applied to the 'absolute' scrolling speed. Can be negative, for a scrolling in the 'down' direction **/
