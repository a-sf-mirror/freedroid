...
void action_push(int type, ...); //XXX should be static
...
int action_toggle_waypoint_connection (level *, int , int );
void level_editor_action_toggle_waypoint_connection_user(level *);
