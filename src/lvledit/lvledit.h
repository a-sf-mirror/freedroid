...
int container_tiles_list[] = {
    ...
    //--------------------
    // We need to render chest with lid opening the other way.
    // For now we repeat the same obstacles once more, cause we should 
    // have at least 10 things in each group for technical reasons...
