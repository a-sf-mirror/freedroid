...
void leveleditor_display() 
{
	...
	if (EditLevel()->random_dungeon)
		DisplayText("This level is automatically generated. Editing will have no effect.", 10, GameConfig.screen_height / 2, NULL, 1.0);
