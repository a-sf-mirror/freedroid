...
mission_status_cheat_handling ( )
{
	...
	if ( CPressed() )
	{
	    Me . AllMissions [ 0 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 0 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 0 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 0 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number1Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 1 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 1 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 1 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 1 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number2Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 2 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 2 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 2 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 2 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number3Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 3 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 3 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 3 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 3 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number4Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 4 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 4 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 4 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 4 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number5Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 5 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 5 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 5 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 5 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number6Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 6 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 6 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 6 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 6 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number7Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 7 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 7 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 7 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 7 ] . MissionIsComplete = FALSE ;
	}
    }
    if ( Number8Pressed() )
    {
	if ( CPressed() )
	{
	    Me . AllMissions [ 8 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 8 ] . MissionIsComplete = TRUE ;
	}
	if ( APressed() )
	{
	    Me . AllMissions [ 8 ] . MissionWasAssigned = TRUE ;
	    Me . AllMissions [ 8 ] . MissionIsComplete = FALSE ;
	}
    }
...
check_for_cheat_keys( void )
{
    ...
    {
	if ( ShiftWasPressed() )
	    DropRandomItem( Me . pos . z , Me . pos . x , Me . pos . y , 3 , TRUE  , FALSE , FALSE ) ;
	else
	    DropRandomItem( Me . pos . z , Me . pos . x , Me . pos . y , 3 , FALSE , FALSE , FALSE ) ;
	...
	{
	    if ( Me . melee_weapon_skill < 8 )  Me . melee_weapon_skill ++ ;
	}
    }
    if ( KP8Pressed() )
    {
	...
	{
	    if ( Me . ranged_weapon_skill < 8 ) Me . ranged_weapon_skill ++ ;
	}
    }
    if ( KP7Pressed() )
    {
    ...
    {
	DebugPrintf( 0 , "\n--------------------\nStarting at x=%d/y=%d.\n" , 
		     (int) Me . pos . x - 5 , (int) Me . pos . y - 5 );
	for ( i = Me . pos . y - 5 ; i < Me . pos . y + 5 ; i ++ )
	{
