...
int LeftPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_LEFT]));}
int RightPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_RIGHT]));}

int UpPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_UP]));}
int DownPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_DOWN]));}
int SpacePressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_SPACE]));}
int EnterPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_RETURN]));}
int EscapePressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_ESCAPE]));}
int LeftCtrlPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_LCTRL]));}

int CtrlPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_LCTRL]) || key_state_array[SDLK_RCTRL]);}

int ShiftPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_RSHIFT] || key_state_array[SDLK_LSHIFT]));}

int AltPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_RALT] || key_state_array[SDLK_LALT])); }

int APressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_a]));}
int HPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_h])) ;}
int MPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_m]));}
int QPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_q])) ;}
int SPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_s]));}
int WPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_w])) ;}
int XPressed () { SDL_PumpEvents(); return ((key_state_array[SDLK_x])) ;}
int MouseRightPressed() { SDL_PumpEvents(); return ((SDL_GetMouseState(NULL, NULL))&(SDL_BUTTON(3))); }
int MouseLeftPressed() { SDL_PumpEvents(); return (SDL_GetMouseState(NULL, NULL)&SDL_BUTTON(1));}
...
int MouseRightUnclicked() { return ((mouse_state_last_frame&SDL_BUTTON(3)) && !(mouse_state_this_frame&SDL_BUTTON(3))); }
int MouseLeftUnclicked() { return ((mouse_state_last_frame&SDL_BUTTON(1)) && !(mouse_state_this_frame&SDL_BUTTON(1))); }
#undef _input_c
