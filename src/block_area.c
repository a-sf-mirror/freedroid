...
// Extreme values for outer wall, to slightly lower problem of tux walking through outer wall door post
	...
	block_2param(ISO_S_TOILET_WHITE_SMALL, 0.4, 0.4);
	obstacle_map[ISO_S_TOILET_WHITE_SMALL].filename = "iso_obstacle_0069.png";
	obstacle_map[ISO_S_TOILET_WHITE_SMALL].flags |= IS_SMASHABLE | GROUND_LEVEL;
	obstacle_map[ISO_S_TOILET_WHITE_SMALL].flags &= ~BLOCKS_VISION_TOO;
	block_2param(ISO_W_TOILET_WHITE_SMALL, 0.4, 0.4);
	obstacle_map[ISO_W_TOILET_WHITE_SMALL].filename = "iso_obstacle_0070.png";
  ...
  /**************************************/
	...
	obstacle_map[ISO_OIL_STAINS_1].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
	...
	obstacle_map[ISO_OIL_STAINS_2].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
	...
	obstacle_map[ISO_OIL_STAINS_3].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
	...
	obstacle_map[ISO_OIL_STAINS_4].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
	...
	obstacle_map[ISO_OIL_STAINS_5].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
	...
	obstacle_map[ISO_OIL_STAINS_6].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
	...
	obstacle_map[ISO_OIL_STAINS_7].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
	...
	obstacle_map[ISO_OIL_STAINS_8].flags |= NEEDS_PRE_PUT | IS_VOLATILE;
...
// IS_NORTH_TO_SOUTH
	...
	block_2param(ISO_TABLE_OVAL_1, 0.85, 1.5);
	...
	block_2param(ISO_TABLE_OVAL_2, 1.5, 0.85);
