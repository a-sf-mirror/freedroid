	...
	switch ( atoi ( Druidmap [ newen . type ] . druidname )) 
		{
                ...
                case 420: strcpy ( newen . short_description_text , _("420 Surgeon") ); break;
                ...
                case 598: strcpy ( newen . short_description_text , _("598 Minister") ); break;
                case 615: strcpy ( newen . short_description_text , _("615 Firedevil") ); break;
                case 629: strcpy ( newen . short_description_text , _("629 Spitfire") ); break;
                case 711: strcpy ( newen . short_description_text , _("711 Grillmeister") ); break;
                case 742: strcpy ( newen . short_description_text , _("742 Zeus") ); break;
                case 751: strcpy ( newen . short_description_text , _("751 Soviet") ); break;
                case 821: strcpy ( newen . short_description_text , _("821 Ufo") ); break;
                case 834: strcpy ( newen . short_description_text , _("834 Wisp") ); break;
                case 883: strcpy ( newen . short_description_text , _("883 Dalex") ); break;
                case 999: strcpy ( newen . short_description_text , _("999 Cerebrum") ); break;
