...
save_string_array("shoplist", (target->shoplist), MAX_ITEMS_IN_NPC_INVENTORY);
save_int32_t_array("shoplistweight", (target->shoplistweight), MAX_ITEMS_IN_NPC_INVENTORY);
...
read_string_array(pos, "shoplist",  (target->shoplist), MAX_ITEMS_IN_NPC_INVENTORY);
read_int32_t_array(pos, "shoplistweight",  (target->shoplistweight), MAX_ITEMS_IN_NPC_INVENTORY);
