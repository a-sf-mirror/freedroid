...
save_float("DAMRED", &(target->DAMRED));
...
save_uint16_t_array("TakeoverFailures", (target->TakeoverFailures), 200);
...
read_float(pos, "DAMRED",  &(target->DAMRED));
...
read_uint16_t_array(pos, "TakeoverFailures",  (target->TakeoverFailures), 200);
...
save_int32_t("bonus_to_damred_or_damage", &(target->bonus_to_damred_or_damage));
...
read_int32_t(pos, "bonus_to_damred_or_damage",  &(target->bonus_to_damred_or_damage));
