...
save_int16_t("is_friendly", &(target->is_friendly));
...
save_char_array("dialog_section_name", (target->dialog_section_name), MAX_LENGTH_FOR_DIALOG_SECTION_NAME);
save_char_array("short_description_text", (target->short_description_text), MAX_LENGTH_OF_SHORT_DESCRIPTION_STRING);
...
read_int16_t(pos, "is_friendly",  &(target->is_friendly));
...
read_char_array(pos, "dialog_section_name",  (target->dialog_section_name), MAX_LENGTH_FOR_DIALOG_SECTION_NAME);
read_char_array(pos, "short_description_text",  (target->short_description_text), MAX_LENGTH_OF_SHORT_DESCRIPTION_STRING);
...
save_cookielist_t_array("cookie_list", (target->cookie_list), MAX_COOKIES);
...
save_bigscrmsg_t_array("BigScreenMessage", (target->BigScreenMessage), MAX_BIG_SCREEN_MESSAGES);
...
read_cookielist_t_array(pos, "cookie_list",  (target->cookie_list), MAX_COOKIES);
...
read_bigscrmsg_t_array(pos, "BigScreenMessage",  (target->BigScreenMessage), MAX_BIG_SCREEN_MESSAGES);
...
save_char_array("freedroid_version_string", (target->freedroid_version_string), 500);
...
read_char_array(pos, "freedroid_version_string",  (target->freedroid_version_string), 500);
