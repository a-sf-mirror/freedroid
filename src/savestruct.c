...
save_moderately_finepoint_array("PrivatePathway", (target->PrivatePathway),  2 );
...
read_moderately_finepoint_array(pos, "PrivatePathway",  (target->PrivatePathway),  2 );
...
save_bigscrmsg_t("BigScreenMessage", &(target->BigScreenMessage));
...
read_bigscrmsg_t(pos, "BigScreenMessage",  &(target->BigScreenMessage));
