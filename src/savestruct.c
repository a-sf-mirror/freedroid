...
save_int32_t("bonus_to_armor", &(target->bonus_to_armor));
...
read_int32_t(pos, "bonus_to_armor",  &(target->bonus_to_armor));
...
save_int32_t("sound_on", &(target->sound_on));
...
read_int32_t(pos, "sound_on",  &(target->sound_on));
