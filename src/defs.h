...
enum { ONLY_SHOW_MAP = 1, DO_SCREEN_UPDATE = 2, ONLY_SHOW_MAP_AND_TEXT = 4, SHOW_TUX_AND_ENEMIES = 8, SHOW_TEXT = 16,
		SHOW_ITEMS = 32, OMIT_OBSTACLES = 64, OMIT_TUX = 128, OMIT_ENEMIES = 256, ZOOM_OUT = 512, OMIT_BLASTS = 1024,
		SKIP_LIGHT_RADIUS = 2048, NO_CURSOR = 4096, OMIT_ITEMS_LABEL = 8192 };
