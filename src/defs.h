...
#define ENEMY_ROTATION_MODELS_AVAILABLE 40
...
enum { ONLY_SHOW_MAP = 1, DO_SCREEN_UPDATE = 2, ONLY_SHOW_MAP_AND_TEXT = 4, SHOW_GRID = 8, SHOW_TUX_AND_ENEMIES = 16, SHOW_TEXT =
	    32, SHOW_ITEMS = 64, OMIT_OBSTACLES = 128, OMIT_TUX = 256, OMIT_ENEMIES = 512, ZOOM_OUT = 1024, OMIT_BLASTS = 2048,
		 SKIP_LIGHT_RADIUS = 4096, NO_CURSOR = 8192, OMIT_ITEMS_LABEL = 16384 };
...
#define ADDON_CRAFTING_BACKGROUND_CODE 34
...
#define ADDON_CRAFTING_RECT_X 320
...
//see at the end for disabled autoguns
	...
	ISO_BOTLINE_05_N,
	ISO_BOTLINE_05_E,
	ISO_MAGNETIC_RAILWAY_01_N,
	ISO_MAGNETIC_RAILWAY_01_E,
	ISO_MAGNETIC_RAILWAY_02_N,
	ISO_MAGNETIC_RAILWAY_02_E,
	ISO_MAGNETIC_RAILWAY_02_W,
	ISO_MAGNETIC_RAILWAY_02_S,
