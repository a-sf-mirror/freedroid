...
// Extreme values for outer wall, to slightly lower problem of tux walking through outer wall door post
    ...
    obstacle_map [ ISO_DV_DOOR_000_OPEN ] . block_area_parm_1 = outer_door_width ;
    ...
    obstacle_map [ ISO_DV_DOOR_025_OPEN ] . block_area_parm_1 = outer_door_width ;
    ...
    obstacle_map [ ISO_DV_DOOR_050_OPEN ] . block_area_parm_1 = outer_door_width ;
    ...
    obstacle_map [ ISO_DV_DOOR_075_OPEN ] . block_area_parm_1 = outer_door_width ;
    ...
    obstacle_map [ ISO_DV_DOOR_100_OPEN ] . block_area_parm_1 = outer_door_width ;
    ...
    obstacle_map [ ISO_DV_DOOR_LOCKED ] . block_area_parm_1 = outer_door_width ;
...
//  obstacle_map [ ISO_H_MESH_FENCE ] . obstacle_long_description = _("To be filled once object appears ingame.");
  ...
  obstacle_map[ ISO_BAR_TABLE ] . obstacle_long_description = _("You can still see some food stains on this yellow round table.");
