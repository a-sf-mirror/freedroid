...
AbstractDataNode::AbstractDataNode(const AbstractNodeType* type, QObject* parent) :
	QObject(parent),
	m_type(type)
{
	Q_ASSERT(type != 0);
...
AbstractNodeType::AbstractNodeType(const QString& name, const QString& description, QObject* parent) :
	QObject(parent),
	m_name(name),
