...
modWPCommon.Wiki.URL_SF = "https://sourceforge.net/p/freedroid/code/ci/master/tree/"
...
function modWPCommon.Wiki.WarnAutoGen( wikitext )
	...
	line = modWPCommon.Wiki.TextColour("DO NOT EDIT PAGE" ,modWPCommon.Wiki.ColourWarn)
	line = line .. " - Page contents are autogenerated from source files."
	text[#text + 1] = modWPCommon.Wiki.TextEmbed(line, "textsmall") .. modWPCommon.Wiki.LineBreakEnd

	line = " Edits will not be preserved when page contents are regenerated. "
